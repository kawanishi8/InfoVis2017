...
function Isosurfaces2( volume, isovalue )
{
    ...
    function value(a,i,v)
    {
        var s0 = v.values[i[0]][0];
        var s1 = v.values[i[1]][0];
        var s2 = v.values[i[2]][0];
        var s3 = v.values[i[3]][0];
        var s4 = v.values[i[4]][0];
        var s5 = v.values[i[5]][0];
        var s6 = v.values[i[6]][0];
        var s7 = v.values[i[7]][0];
        if (a == 0) { return [s0, s1] }
        else if (a == 1) { return [s1, s5] }
        else if (a == 2) { return [s5, s4] }
        else if (a == 3) { return [s4, s0] }
        else if (a == 4) { return [s3, s2] }
        else if (a == 5) { return [s2, s6] }
        else if (a == 6) { return [s6, s7] }
        else if (a == 7) { return [s7, s3] }
        else if (a == 8) { return [s0, s3] }
        else if (a == 9) { return [s1, s2] }
        else if (a == 10) { return [s5, s6] }
        else { return [s4, s7] }
    }
}
